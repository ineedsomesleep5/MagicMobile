...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            ...
            sources: ["OnDeviceAppConfigurationTests.swift", "OnDeviceModelTests.swift", "OnDeviceSnapshotAdapterTests.swift", "OnDevicePromptAdapterTests.swift", "OnDeviceMultiplayerTests.swift", "OnDeviceSessionTests.swift", "OnDeviceReadinessRegressionTests.swift", "OnDeviceSessionLifecycleTests.swift", "OnDeviceDeckResolverTests.swift", "OnDeviceBackendRegistrationTests.swift", "OnDeviceMessageLogTests.swift", "OnDeviceMessageSessionTests.swift", "OnDeviceDiagnosticsTests.swift", "PortraitInteractionPolicyTests.swift", "OnDeviceYieldPolicyTests.swift"],
