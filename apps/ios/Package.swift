...
let package = Package(
    ...
    targets: [
        .target(
            ...
            sources: ["NativeArtworkCatalogue.swift", "DeckStudio/Core", "DeckStudio/Services", "GameLogPresentation.swift", "BattlefieldAdaptiveSizing.swift", "NativeDeckEDHREC.swift", "NativeDeckMetadataCatalogue.swift", "OnDeviceAppConfiguration.swift", "Models.swift", "MagicMobileAPI.swift", "PromptCommandBuilder.swift", "PreconCatalog.swift", "OnDeviceDeckResolver.swift", "OnDeviceDeckEditing.swift", "OnDeviceDeckLinkImporter.swift", "NativeDeckArtwork.swift", "NativeAssetDownloads.swift", "OnDeviceSnapshotAdapter.swift", "OnDevicePromptAdapter.swift", "OnDeviceMultiplayer.swift", "OnDeviceSession.swift", "OnDeviceRuntimeManager.swift", "OnDeviceBackendRegistration.swift", "OnDeviceMessageLog.swift", "OnDeviceDiagnostics.swift", "PortraitInteractionPolicy.swift", "OnDeviceYieldPolicy.swift", "BoardZoneReference.swift"],
