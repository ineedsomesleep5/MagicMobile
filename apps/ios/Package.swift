...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(
            ...
            sources: ["OnDeviceAppConfigurationTests.swift", "OnDeviceModelTests.swift", "OnDeviceSnapshotAdapterTests.swift", "OnDevicePromptAdapterTests.swift", "OnDeviceMultiplayerTests.swift", "OnDeviceSessionTests.swift", "OnDeviceDeckResolverTests.swift", "OnDeviceBackendRegistrationTests.swift"],
