...
6. **Full-AI fixture expansion**: Add targeted deterministic prompt scenarios for `choose_multi_amount`, `choose_pile`, and damage assignment. Suggested representative fixture cards are `Manamorphose` and `Fact or Fiction`, using a Commander-legal five-color fixture shell when needed.
