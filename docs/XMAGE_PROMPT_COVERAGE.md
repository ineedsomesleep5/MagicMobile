...
| **Order Triggers / Items** | `order_triggers`, `order_items` | Yes | Yes | No | Mapped and unit-tested; triggered-stack visibility is fixture-proven, but explicit multi-trigger ordering still needs a targeted XMage prompt. |
