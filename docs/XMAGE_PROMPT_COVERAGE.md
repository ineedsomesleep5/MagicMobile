...
The latest targeted `prompt-order` proof on June 24, 2026 used game `d8763ace-f8fc-412b-8537-f93ba2c02207`, real `source: "xmage-java-bridge"`, `fixtureCallUsed: true`, `directStateSeeded: true`, `seededStateVerified: true`, final `bridgeRevision: 29`, final `xmageCycle: 50`, `promptFamiliesSeen: ["GAME_PLAY_MANA:mana", "GAME_TARGET:order"]`, `actionsByType.order_items: 1`, `promptOrder.choiceSubmitted: true`, `routeFamiliesMissing: []`, and `stepsBlocked: []`. This proves the generic trigger/item ordering route with Soul Warden plus Spirited Companion; it does not prove multi-amount, pile, or damage-assignment prompts.

The latest targeted `prompt-amount` proof on June 24, 2026 used game `da1e4c2e-533e-4cb5-987f-d1ff76cd0aca`, real `source: "xmage-java-bridge"`, `fixtureCallUsed: true`, `directStateSeeded: true`, `seededStateVerified: true`, final `bridgeRevision: 18`, final `xmageCycle: 24`, `promptFamiliesSeen: ["GAME_GET_AMOUNT:amount"]`, `actionsByType.choose_amount: 1`, `promptAmount.choiceSubmitted: true`, `routeFamiliesMissing: []`, and `stepsBlocked: []`. This proves the generic amount route with Wheel of Misfortune's upstream `Player.getAmount(...)`; it does not prove `play_x_mana`, multi-amount, pile, or damage-assignment prompts.

The latest targeted `prompt-multi-amount` proof on June 24, 2026 used game `75488774-6919-4003-b77f-d4e3371dd48d`, real `source: "xmage-java-bridge"`, `fixtureCallUsed: true`, `directStateSeeded: true`, `seededStateVerified: true`, final `bridgeRevision: 18`, final `xmageCycle: 29`, `promptFamiliesSeen: ["GAME_GET_MULTI_AMOUNT:multi_amount"]`, `actionsByType.choose_multi_amount: 1`, `promptMultiAmount.choiceSubmitted: true`, `promptMultiAmount.choiceResolved: true`, `routeFamiliesMissing: []`, and `stepsBlocked: []`. This proves the generic multi-amount route with Manamorphose's upstream `AddManaInAnyCombinationEffect`; it does not prove pile or damage-assignment prompts.
...
`prompt-variety` is a route-family proof, not a count of any three prompts. It requires real XMage evidence for `stack_object_seen`, `activate_ability`, `choose_ability`, `choose_mode`, `order_triggers/order_items`, `choose_amount`, `choose_multi_amount`, and `choose_pile`. The standalone `prompt-variety` scenario remains red; `prompt-mode`, `prompt-order`, `prompt-amount`, and `prompt-multi-amount` are targeted prompt-variety slices and are now part of the stricter `commander-full-ai` gate. Do not describe full-product readiness until targeted fixture reports prove every required prompt family or explicitly exclude it with a safe iOS fallback.
