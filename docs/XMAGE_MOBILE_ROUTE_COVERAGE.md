...
| damage assignment | Combat damage assignment prompt/routes | No generic route found | No | No | No | Named safe fallback; refuses to submit a default split | Probe only; no successful fixture proof | No | bridge missing | Map the actual XMage damage assignment callback/action when encountered; current full-AI gate must fail until this is real or formally excluded. |
